...
Given('an OAuth client exists with id {string}', function (this: TestWorld, clientId: string) {
  this.client = {
    id: clientId,
    secret: 'test-secret',
    name: 'Test Client',
...
Given('a user exists with id {string}', function (this: TestWorld, userId: string) {
  this.user = {
    id: userId,
...
Given('an authorization code {string} has been used', function (this: TestWorld, code: string) {
  this.authCode = {
    code,
    used: true,
  };
...
Given('an authorization code {string} expired {int} minutes ago', function (this: TestWorld, code: string, minutes: number) {
  this.authCode = {
    code,
...
Given('an authorization code {string} with redirect_uri {string}', function (this: TestWorld, code: string, redirectUri: string) {
  this.authCode = {
    code,
    redirectUri,
  };
...
Given('an authorization code with PKCE exists:', function (this: TestWorld, table: any) {
  const data = table.rowsHash();
  this.authCode = {
    code: data.code,
...
Given('a refresh token for client {string}', function (this: TestWorld, clientId: string) {
  this.refreshToken = {
...
Given('the refresh token {string} expired {int} day ago', function (this: TestWorld, token: string, days: number) {
  this.refreshToken = {
    token,
...
Given('the refresh token {string} has been revoked', function (this: TestWorld, token: string) {
  this.refreshToken = {
    token,
    revoked: true,
  };
...
When('I register a new OAuth client with:', function (this: TestWorld, table: any) {
  const data = table.rowsHash();
  this.response = {
    status: 201,
    body: {
...
When('I try to register a client with redirect URI {string}', function (this: TestWorld, redirectUri: string) {
  this.error = {
    status: 400,
...
When('the client requests authorization with:', function (this: TestWorld, table: any) {
  const data = table.rowsHash();
  this.response = {
    authRequest: {
...
When('the client requests authorization with PKCE:', function (this: TestWorld, table: any) {
  const data = table.rowsHash();
  this.response = {
    authRequest: {
      client_id: data.client_id,
...
When('the client exchanges the code for tokens with:', function (this: TestWorld, table: any) {
  const data = table.rowsHash();
  this.response = {
    status: 200,
    body: {
...
When('the client tries to exchange {string} for tokens', function (this: TestWorld, code: string) {
  this.error = {
    error: 'invalid_grant',
...
When('the client exchanges the code with wrong redirect_uri {string}', function (this: TestWorld, redirectUri: string) {
  this.error = {
...
When('the client exchanges the code with code_verifier {string}', function (this: TestWorld, codeVerifier: string) {
  this.response = {
    status: 200,
    body: {
      access_token: 'jwt-access-token',
...
When('the client exchanges the code with wrong code_verifier', function (this: TestWorld) {
  this.error = {
    error: 'invalid_grant',
...
When('I delete the client {string}', function (this: TestWorld, clientId: string) {
  this.response = {
    status: 204,
...
When('{string} tries to use the refresh token', function (this: TestWorld, clientId: string) {
  this.error = {
...
When('I try to refresh with invalid token {string}', function (this: TestWorld, token: string) {
  this.error = {
    error: 'invalid_grant',
...
When('the client requests token refresh with:', function (this: TestWorld, table: any) {
  const data = table.rowsHash();
  this.response = {
    status: 200,
    body: {
...
When('the client tries to refresh with {string}', function (this: TestWorld, token: string) {
  if (this.refreshToken?.expiresAt && new Date(this.refreshToken.expiresAt) < new Date()) {
    this.error = {
      error: 'invalid_grant',
      error_description: 'Refresh token expired',
    };
...
Then('the client should have the specified configuration', function (this: TestWorld) {
  expect(this.responseBody).toBeTruthy();
  expect(this.responseBody?.name).toBeTruthy();
});

Then('the request should fail with validation error', function (this: TestWorld) {
  expect(this.error?.status).toBe(400);
});

Then('the error should mention {string}', function (this: TestWorld, errorMessage: string) {
...
Then('the client should have the new configuration', function (this: TestWorld) {
  expect(this.responseBody).toBeTruthy();
});
...
Then('the user should be redirected to {string}', function (this: TestWorld, redirectUri: string) {
...
Then('an authorization code should be generated with PKCE', function (this: TestWorld) {
  expect(this.authCode?.code).toBeTruthy();
});
...
Then('the request should fail with error {string}', function (this: TestWorld, errorCode: string) {
  expect(this.error?.error).toBe(errorCode);
});

Then('the error_description should be {string}', function (this: TestWorld, description: string) {
...
Then('the token_type should be {string}', function (this: TestWorld, tokenType: string) {
  expect(this.responseBody?.token_type).toBe(tokenType);
});

Then('the expires_in should be {int}', function (this: TestWorld, expiresIn: number) {
...
Then('the error_description should contain {string}', function (this: TestWorld, text: string) {
